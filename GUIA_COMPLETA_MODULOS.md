...
- [ Módulos de Escaneo](#️-módulos-de-escaneo)
...
### 4. Network Mapper (Mapeador de Red)
...
### 11. CSRF Scanner (Escáner de Falsificación de Peticiones)
...
** ADVERTENCIA**: Estos módulos realizan ataques reales. SOLO úsalos en sistemas que tienes permiso de probar.
